...
const ProfileCard = ({ params }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <section className="shadow-md rounded-lg mt-4 mb-4 w-9/10 bg-white">
        <div className="flex flex-col items-center relative">
          ...
          />
          <div className="flex flex-col items-center">
            <p className="text-4xl font-bold mt-2">{session?.user.name}</p>
            <p className="text-xl text-gray-500 p-1">{session?.user.email}</p>
          </div>
        </div>
        <div className="p-1 flex flex-col justify-around">
          <div className="flex flex-col items-center p-1">
            <p className="text-xl text-gray-600 p-1 mb-2 text-center font-semibold">{profileData.bio}</p>
          </div>
          <div className="flex flex-row items-center text-xl mb-2 justify-around">
        ...
        <div className="flex flex-row shadow-md justify-around p-2 mt-3 border-t-2 rounded-lg w-full bg-white">
        <Createpost />
        <Profilebtn />
      </div>
      </section>
