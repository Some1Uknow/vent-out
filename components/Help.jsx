    ...
    <div>
      <section className=" shadow-md rounded-lg p-2 h-max w-9/10 m-1 mt-4 bg-white border-t-2">
        <div className="flex flex-row p-1">
          <Image
            className="object-cover w-34 h-34 border-2 mr-2 shadow-sm"
            // height={24}
            // width={84}
            alt="user-image"
          />
          <div className="flex flex-col">
            ...
            <p className="text-xl text-gray-500 font-semibold mb-1">{years} years of experience</p>
            <p className="text-sm border-2 rounded-lg p-1 text-gray-500 mb-1 cursor-pointer" onClick={() => handleEmailClick(email)}>Email: {email}</p>
            <p className="text-sm border-2 rounded-lg p-1 text-gray-500 mb-1">Country: {country}</p>
            <p className="text-sm border-2 rounded-lg p-1 text-gray-500 mb-1">Company: {company}</p>
          </div>
        </div>
